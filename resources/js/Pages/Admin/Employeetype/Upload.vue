    ...
    <div class="p-2 px-8">
      <div class="px-4 py-4 sm:px-6 md:px-8">
        <form class="mx-auto mt-8 max-w-lg" @submit.prevent="uploadCSV">
          <p class="mb-6">
            Import multiple employee_types at one time. The cost codes file must
            be in the format shown in the
            <a
            ...
            >
              <div class="flex flex-col items-center justify-center pb-3 pt-2">
                ...
                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                  Upload employee types file here
                </p>
                <!---->
              </div>
              <input
...
const crumbspage = ref([
  ...
  { label: "Upload", href: "/cost-codes/create" },
]);
...
const uploadCSV = () => {
  ...
  router.post(route("employee-types.import"), formData, {
