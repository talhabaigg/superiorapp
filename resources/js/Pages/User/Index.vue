<template>
    ...
    <div class="mt-4 flex items-center space-x-4 mx-auto max-w-7xl">
        ...
        <div class="mt-2 relative overflow-x-auto mx-auto max-w-7xl rounded-lg  sm:block overflow-y-hidden">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="bg-gray-300">
          <tr>
            ...
            <th scope="col" class=" px-3 py-3.5 text-left text-sm font-semibold text-gray-900 md:table-cell">Email</th>
          </tr>
        </thead>
